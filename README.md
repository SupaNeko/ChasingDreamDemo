...
> 当前仓库主要包含 PRD、产品/设计上下文、spec 和开发计划文档。应用代码尚未实现，下面部署方法描述的是本 Demo 按计划实现后的运行方式。
...
《巡梦》是一个梦境记录 Demo：用户输入梦境碎片，由 Agent 温柔拼合成故事，提取情绪与关键词，并保存到日历中回看。它不是解梦或诊断工具，而是一个安静、安全的梦境承接空间。
